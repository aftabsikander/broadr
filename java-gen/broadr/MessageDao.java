...
public class MessageDao extends AbstractDao<Message, Long> {
    ...
    ;
    private Query<Message> board_MessagesQuery;
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MESSAGE' (" + //
                ...
                "'BOARD_ID' INTEGER NOT NULL );"); // 9: boardId
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Message entity) {
        ...
        stmt.bindLong(10, entity.getBoardId());
    }
    ...
    public Message readEntity(Cursor cursor, int offset) {
        Message entity = new Message( //
                ...
                cursor.getLong(offset + 9) // boardId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Message entity, int offset) {
        ...
        entity.setBoardId(cursor.getLong(offset + 9));
    }
    ...
    /**
     * Internal query to resolve the "messages" to-many relationship of Board.
     */
    public List<Message> _queryBoard_Messages(long boardId) {
        synchronized (this) {
            if (board_MessagesQuery == null) {
                QueryBuilder<Message> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.BoardId.eq(null));
                board_MessagesQuery = queryBuilder.build();
            }
        }
        Query<Message> query = board_MessagesQuery.forCurrentThread();
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getBoardDao().getAllColumns());
    ...
    public static class Properties {
        ...
        public final static Property BoardId = new Property(9, long.class, "boardId", false, "BOARD_ID");
    }
