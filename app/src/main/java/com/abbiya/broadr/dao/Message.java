...
public class Message implements Serializable {
    ...
    public Message(Long id, String uuid, String content, java.util.Date happenedAt, String geoHash, Integer type, Integer status, java.util.Date updatedAt) {
        this.id = id;
        this.uuid = uuid;
    ...
    public Message(Long id, String content, java.util.Date happenedAt, String geoHash, Integer type) {
        this.id = id;
        this.content = content;
        this.happenedAt = happenedAt;
        this.geoHash = geoHash;
    ...
    public Message(Long id, String content, java.util.Date happenedAt, String geoHash, Integer type, Integer status, java.util.Date updatedAt) {
        this.id = id;
        this.content = content;
        this.happenedAt = happenedAt;
        this.geoHash = geoHash;
    ...
    public Message(String content, java.util.Date happenedAt, String geoHash) {
        this.content = content;
        this.happenedAt = happenedAt;
        this.geoHash = geoHash;
    }

    public Message(String content, int type, int status) {
        this.content = content;
        this.type = type;
        this.status = status;
    }

    public Message(String content, java.util.Date happenedAt, String geoHash, Integer type) {
        this.content = content;
        this.happenedAt = happenedAt;
        this.geoHash = geoHash;
        this.type = type;
    ...
    public Message(Long id, String uuid, String content, java.util.Date happenedAt, String geoHash, String address, Integer type, Integer status, java.util.Date updatedAt) {
        this.id = id;
        this.uuid = uuid;
        this.content = content;
        this.happenedAt = happenedAt;
